...
\title[Soutenance de Stage]{Soutenance du Stage de deuxième année F4\\Amélioration d'algorithme d'apprentissage pour la localisation en environnement intérieur}
...
\begin{frame}{Objectifs du groupe ALTIPHARMA}
  \begin{itemize}
    \item ALTIPHARMA
    \begin{itemize}
      \item Groupement de pharmacies en France
      \item Clients potentiels : plus de 250 000 personnes
      \item Représentant : M. PORTAL
    \end{itemize}
    \item[]
    \item Objectifs
    \begin{itemize}
      \item Suivi de clients au sein de la pharmacie
