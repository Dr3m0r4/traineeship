...
def add_training_args(parser):
    ...
    parser.add_argument(
        "--mom",
        help="[Training only] Set momentum start or fixed",
        type=float,
        default=0.01)

    parser.add_argument(
        "--mom_end",
        help="[Training only] Set momentum end",
        type=float,
        default=0.01)
    ...
    parser.add_argument(
        "--nb_cycle",
        help="number of cycle you should do, it is only available for learning rate modification",
        type=int,
        default=1)
